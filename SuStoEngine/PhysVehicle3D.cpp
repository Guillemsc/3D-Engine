...
void PhysVehicle3D::Render()
{
	...
	//--------
	PCube front_forkTube(info.front_forkTube_size.x, info.front_forkTube_size.y, info.front_forkTube_size.z);
	...
	//--------
	PCube back_forkTube(info.back_forkTube_size.x, info.back_forkTube_size.y, info.back_forkTube_size.z);
	...
	//--------
	PCube handleBar(info.handleBar_size.x, info.handleBar_size.y, info.handleBar_size.z);
	...
	//--------
	PCube front_seat(info.front_seat_size.x, info.front_seat_size.y, info.front_seat_size.z);
	...
	//--------
	PCube back_seat(info.back_seat_size.x, info.back_seat_size.y, info.back_seat_size.z);
	...
	//--------
	PCube back_seat_colored(info.back_seat_colored_size.x, info.back_seat_colored_size.y, info.back_seat_colored_size.z);
	...
	//-----------
	PCube torso(info.torso_size.x, info.torso_size.y, info.torso_size.z);
	...
	//-----------
	PCube biceps1(info.biceps1_size.x, info.biceps1_size.y, info.biceps1_size.z);
	...
	//-----------
	PCube biceps2(info.biceps2_size.x, info.biceps2_size.y, info.biceps2_size.z);
